			...
			'data' => [
				'createMediaItem' => [
					...
					'mediaItem' => [
						...
						'altText'          => $this->altText,
						'caption'          => apply_filters( 'the_excerpt', apply_filters( 'get_the_excerpt', $this->caption ) ),
						'commentStatus'    => $this->commentStatus,
						'date'             => $this->date,
						'dateGmt'          => $this->dateGmt,
						'slug'             => $this->slug,
			...
			'data' => [
				'updateMediaItem' => [
					...
					'mediaItem'             => [
						...
						'altText'          => $this->updated_altText,
						'caption'          => apply_filters( 'the_excerpt', apply_filters( 'get_the_excerpt', $this->updated_caption ) ),
						'commentStatus'    => $this->updated_commentStatus,
						'date'             => $this->updated_date,
						'dateGmt'          => $this->updated_dateGmt,
						'slug'             => $this->updated_slug,

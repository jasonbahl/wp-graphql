...
class PostObjectConnectionResolver extends ConnectionResolver {
	...
	/**
	 * Holds the value of the $last arg input to the connection field, identifies how many items to paginate from
	 * the back of the data set
	 *
	 * @var int $last_arg
	 */
	...
	/**
	 * Holds the value of the $first arg input to the connection field, identifies how many items to paginate from
	 * the front of the data set
	 *
	 * @var int $first_arg
	 */
	...
	protected static function set_cache_query_args( $source, $args, AppContext $context, ResolveInfo $info ) {
